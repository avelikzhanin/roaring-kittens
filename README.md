...
Сканер (Phase 5.5): каждый торговый день в 10:40 МСК — скрининг топ-10 бумаг
IMOEX по весу (gpt-4o-mini, ~цент за день), полный комитет — только по лучшему
кандидату (score≥70, ≤1/день, исключение 7 дней по council_runs — вето-прогоны
тоже считаются). Идеи уходят всем подключённым.
