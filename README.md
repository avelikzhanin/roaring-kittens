...
**Сейчас (Phase 4b):** мультитенантность (друзья с инвайт-кодами и СВОИМИ Tinkoff-токенами,
per-user бюджеты 80%→эконом / 100%→блок), реактивность (5-мин News Watcher, Impact
Classifier, HIGH→авто-комитет, quiet hours, /watch, прайс-алерты ≥5%), память и тезисы,
мультиагентный комитет (`/council`), Trust Loop (`/track`), `/ask`, утренний дайджест.
