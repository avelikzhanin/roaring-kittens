...
Для action=buy ОБЯЗАТЕЛЬНО заполни target_price (цель фиксации прибыли) и exit_price
(уровень выхода НИЖЕ текущей цены). Отталкивайся от текущей цены и уровней
поддержки/сопротивления из технического блока. Числа в ₽."""
