...
HELP_TEXT = (
    ...
    "<b>💼 Сделки — главное:</b>\n"
    "Я сам слежу за новостями и рынком (каждый день сканирую топ бумаг индекса). "
    "Когда мой комитет аналитиков находит интересную покупку — присылаю идею: "
    "цена входа, 🎯 цель, 🛑 «продаём если» и размер под твой портфель. "
    "Жмёшь [✅ Беру] → покупаешь в Т-Инвестициях → я вижу покупку на счёте "
    "и веду сделку до сигнала выхода. Свои покупки тоже подхвачу.\n"
    ...
    "<b>Для владельца:</b> <code>/admin</code> — юзеры и инвайты · "
    "<code>/insights</code> — уроки бота · <code>/seed_retro</code> — прогрев истории\n\n"
